...
class Scene extends React.Component {
  ...
  componentDidMount() {
    ...
    function onCollision(pair) {
      ...
      var condition11 = pair.bodyA.label === 'border1' && pair.bodyB.label === 'bullet';
      var condition12 = pair.bodyA.label === 'bullet' && pair.bodyB.label === 'border1';
      var condition13 = pair.bodyA.label === 'border1' && pair.bodyB.label === 'player';
      var condition14 = pair.bodyA.label === 'player' && pair.bodyB.label === 'border1';
      var condition15 = pair.bodyA.label === 'platform' && pair.bodyB.label === 'bullet';
      var condition16 = pair.bodyA.label === 'bullet' && pair.bodyB.label === 'platform';


      //returns true condition
      return condition1 || condition2 || condition3 || condition4 || condition5 || condition6 || condition7 || condition8 | condition9 || condition10 || condition11 || condition12 || condition13 || condition14 || condition15 || condition16;
    };
    ...
    function playerRespawn(pair) {
      if ((pair.bodyA.label === 'border1') && (pair.bodyB.label === 'player')) {
        player.position = { x: 400, y: 200 }
      };

      if ((pair.bodyA.label === 'player') && (pair.bodyB.label === 'border1')) {
        player.position = { x: 400, y: 200 }
      };
    };
    ...
    World.add(mainEngine, [
      ...
      //top border
      Bodies.rectangle(0, 0, 11000, 10, { isStatic: true, label: "border" }),
      //left border
      Bodies.rectangle(0, 0, 10, 3000, { isStatic: true, label: "border" }),
      //right border
      Bodies.rectangle(5500, 0, 10, 3000, { isStatic: true, label: "border" }),
      // bottom border
      Bodies.rectangle(0, 1450, 11000, 100, { isStatic: true, label: "border1" }),
    ]);
